      ...
      <DefaultLayout>
        ...
        <form action="/movies" method="POST">
          <fieldset>
            ...
            <label>TITLE:<input type="text" name="title" placeholder="Enter movie title" /></label>

            <label>GENRE:<input type="text" name="genre" placeholder="enter genre" /></label>
            ...
            <label>CAST: (Please separate case members with "|")<input type="text" name="cast" /></label>
