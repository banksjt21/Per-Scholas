            ...
            <DefaultLayout>
                ...
                <form action={`/movies/${movie._id}?_method=PUT`} method="POST">
                    <fieldset>
                        ...
                        <label>
                            TITLE:<input type="text" name="title" placeholder="Enter movie title" defaultValue={movie.title} />
                        </label>

                        <label>
                            GENRE:<input type="text" name="genre" placeholder="enter genre"  defaultValue={movie.genre} />
                        </label>
