...
const radio = {
    ...
    changeStation: () => {
      ...
      stationName.textContent = `${newStation.name}`;
  ...
  let changeStationButton = document.querySelector('#changeStationButton');
  changeStationButton.addEventListener('click', radio.changeStation);
